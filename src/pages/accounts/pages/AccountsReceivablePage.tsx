...
const AccountsReceivablePage: React.FC = () => {
  ...
  const data = [
    { customer: "ABC Hospital", invoices: 3, totalDue: 125000, overdue: 25000, current: 100000, status: "Partial" },
    { customer: "XYZ Clinic", invoices: 2, totalDue: 95000, overdue: 0, current: 95000, status: "Current" },
    { customer: "MediCare Ltd", invoices: 4, totalDue: 180000, overdue: 45000, current: 135000, status: "Overdue" },
    { customer: "City Clinic", invoices: 1, totalDue: 50000, overdue: 0, current: 50000, status: "Current" },
  ];
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">Outstanding customer invoices and aging analysis</p>
      </div>
      ...
      <div className="bg-white p-4 rounded shadow mb-4">
        <div className="flex gap-4 items-end">
          <div>
            ...
            <select value={customerFilter} onChange={e => setCustomerFilter(e.target.value)} className="px-3 py-2 border rounded w-48">
              <option value="all">All Customers</option>
              <option value="abc">ABC Hospital</option>
              <option value="xyz">XYZ Clinic</option>
            </select>
          </div>
          <div>
