...
const AccountsPayablePage: React.FC = () => {
  ...
  const data = [
    { vendor: "ABC Suppliers", invoices: 2, totalDue: 85000, overdue: 0, current: 85000, dueDate: "2026-02-15", status: "Current" },
    { vendor: "XYZ Vendors", invoices: 3, totalDue: 120000, overdue: 30000, current: 90000, dueDate: "2026-01-20", status: "Overdue" },
    { vendor: "Tech Corp", invoices: 1, totalDue: 45000, overdue: 0, current: 45000, dueDate: "2026-02-20", status: "Current" },
    { vendor: "Medical Supplies Inc", invoices: 4, totalDue: 95000, overdue: 15000, current: 80000, dueDate: "2026-01-30", status: "Partial" },
  ];
  ...
  }), { invoices: 0, totalDue: 0, overdue: 0, current: 0 });

  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Accounts Payable Report</h1>
        <p className="text-sm text-gray-600">Outstanding vendor invoices and payment schedule</p>
      </div>
      ...
      <div className="bg-white p-4 rounded shadow mb-4">
        <div className="flex gap-4 items-end">
          <div>
            ...
            <select value={vendorFilter} onChange={e => setVendorFilter(e.target.value)} className="px-3 py-2 border rounded w-48">
              <option value="all">All Vendors</option>
              <option value="abc">ABC Suppliers</option>
              <option value="xyz">XYZ Vendors</option>
            </select>
          </div>
          <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-green-50 p-4 rounded">
          ...
          <div className="text-2xl font-bold text-green-700">₹{totals.current.toLocaleString()}</div>
        </div>
