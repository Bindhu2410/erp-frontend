    ...
    try {
      ...
      const [eventsRes, meetingsRes, callsRes, tasksRes] =
        await Promise.allSettled([
          fetch("http://localhost:5104/api/SalesActivityEvent"),
          fetch("http://localhost:5104/api/SalesActivityMeeting"),
          fetch("http://localhost:5104/api/SalesActivityCall"),
          fetch("http://localhost:5104/api/SalesActivityTask"),
        ]);
