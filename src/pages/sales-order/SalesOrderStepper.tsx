...
const SalesOrderStepper: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-gradient-to-br from-white to-gray-100 rounded-xl shadow-lg">
      ...
      <div className="relative mb-12 overflow-x-auto pb-4">
        <div className="absolute top-1/3 left-0 w-full min-w-[600px] h-1 bg-gray-200"></div>
